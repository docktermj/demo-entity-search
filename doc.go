...
More information can be found in the [pkg/github.com/docktermj/demo-entity-search/examplepackage] documentation.
...
Examples of use can be seen in the main_test.go files.
	...
	import (
		...
		"github.com/docktermj/demo-entity-search/anotherpackage"
	)
